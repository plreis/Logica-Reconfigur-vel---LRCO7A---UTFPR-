...
package spi_param_pkg is
    ...
    -- NOTA: evitamos "WRITE_MODE"/"READ_MODE" pois conflitam com o tipo
    -- file_open_kind de std.standard (VHDL 2008 / Quartus 25.x).
    constant SPI_WRITE : std_logic_vector(1 downto 0) := "00";
    constant SPI_READ  : std_logic_vector(1 downto 0) := "10";
