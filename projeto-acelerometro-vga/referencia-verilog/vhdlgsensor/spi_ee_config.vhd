    ...
    begin
        if reset_n = '0' then
            ...
            if ini_index < INI_NUMBER then
                case spi_state is
                    when SPI_IDLE =>
                        -- Monta palavra: SPI_WRITE_MODE (2b) + endereço (6b) + dado (8b)
